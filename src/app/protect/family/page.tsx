...
export const metadata: Metadata = {
  title: "Family Digital Safety — Cognitron Protect",
  description:
    "Protect your children online and secure your home network. Device security, parental controls, and ongoing support.",
};
